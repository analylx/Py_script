...
def do_write(unit,ip_head):
    with open(file_path, 'a') as fi:
        fi.write("""set interfaces ge-ts2/2 unit {0} family inet address 172.18.{1}.56/24
set interfaces ge-ts2/2 unit {0} vlan-id-list {0}
set protocols bfd interface ge-ts2/2.{0} destination 172.18.{1}.58
""".format(unit,ip_head))

...
set interfaces xe-ts17/3 unit {0} family mpls
set interfaces xe-ts17/3 unit {0} vlan-id-list {0}
set protocols mpls static tunnel bidirectional {0} head-and-tail main in-segment interface xe-ts17/3.{0}
set protocols mpls static tunnel bidirectional {0} head-and-tail main in-segment label 51{0}
set protocols mpls static tunnel bidirectional {0} head-and-tail main out-segment interface xe-ts17/3.{0}
set protocols mpls static tunnel bidirectional {0} head-and-tail main out-segment label 51{0}
set protocols mpls static tunnel bidirectional {0} head-and-tail to 200.200.150.81

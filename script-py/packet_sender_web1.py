...
def create_protocols_tree():
    ...
    ipv6_packet_tree_entry = protocols_tree.insert(
        ip_layer_tree_entry, 0, "IPv6包", text="IPv6包")
    icmp_packet_tree_entry = protocols_tree.insert(
        ip_layer_tree_entry, 1, "ICMP包", text="ICMP包")
    icmp6_packet_tree_entry = protocols_tree.insert(
        ip_layer_tree_entry, 1, "ICMPv6包", text="ICMPv6包")

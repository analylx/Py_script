...
class MyApp(App):
    ...
    def main(self):
        ...
        self.lbl = gui.Label(
            'This is a LABEL!', width=200, height=30, margin='10px')
        ...
        self.video = gui.Widget(
            _type='iframe', width=290, height=200, margin='10px')
        ...
        subContainerRight.append([
            self.counter, self.lbl, self.bt, self.txt, self.spin, self.check,
            self.btInputDiag, self.btFileDiag
        ])
    ...
    def menu_dialog_clicked(self, widget):
        ...
        self.ddropdown = gui.DropDown.new_from_list(
            ('DropDownItem 0', 'DropDownItem 1'), width=200, height=20)

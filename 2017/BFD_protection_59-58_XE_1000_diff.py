...
set protocols mpls static tunnel bidirectional {0} head-and-tail main bfd minimum-receive-interval 1000 minimum-transmit-interval 1000 multiplier 3
...
set protocols mpls static tunnel bidirectional {0} head-and-tail protection bfd minimum-receive-interval 1000 minimum-transmit-interval 1000 multiplier 3
